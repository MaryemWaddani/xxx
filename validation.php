                                ...
                                <div class="table-responsive table--no-card m-b-40">
                                    <table class="table table-borderless table-striped table-earning">
										...
										include("connexion.php");
											...
											$sql = "Select * from courriers where validation=false";
											...
											{
										?>
                                            <tr data-sh="<?php echo $val["shemin"]?>" data-ref="<?php echo $val["ref_bo"]?>">
                                                <td><?php echo $val["etat"]?></td>
                                                <td><?php echo $val["date_arrivee"]?></td>
												<td><?php echo $val["detailles"]?></td>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div id="example1"></div>
		<div id="example2"><a href="" class="btn btn-success">valider </a></div>
      </div>
    </div>
	...
	<script>
	  $("tr").click(function(){
		...
		if(dt!=null){
	  PDFObject.embed(dt, "#example1");
	  $("#example2 a").attr("href","validation_script.php?ref="+ref);
		$("#myModal").modal("show");
		}
	  });
