                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                               ...
                               <form action="script_ajoute.php" method="post" enctype="multipart/form-data">
							   <div class="form-group" >
										<label for="">email</label>
										<select name="eml" class="form-control">
										  <?php 
										     include("connexion.php");
											 $rq="select * from employes";
											$stmt= $bdd->prepare($rq);
											$res=$stmt->execute();
											$tab=$stmt->fetchAll();
											 foreach($tab as $val)
											 {
											 ?>
										  <option value="<?php echo $val["email_employe"] ?>"><?php echo $val["email_employe"] ?></option>
											 <?php
											 }
										 ?>
										  </select>
									...
									<div class="form-group">
										...
										<select name="etat" class="form-control">
										  <option value="arrivés externe">arrivés externe</option>
										  <option value="sortants externe">sortants externe</option>
									...
									<div class="form-group">
										<label for="comment">detailles:</label>
										<textarea class="form-control" rows="5" name="det"></textarea>
										</div>
										
										<div class="form-group">
										<label >fichier:</label>
										<input type="file" name="fl" class="form-control" >
									</div>
